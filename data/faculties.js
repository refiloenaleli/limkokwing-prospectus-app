const faculties = [
  {
    ...
    facultyImage: require('../assets/images/fict_course1.jpg'),
    courses: [
      {
...

  {
    ...
    facultyImage: require('../assets/images/tourism_course1.jpg'),
    courses: [
      {
...

  {
    ...
    facultyImage: require('../assets/images/business_course1.jpg'),
    courses: [
      {
...

  {
    ...
    facultyImage: require('../assets/images/comm_course1.jpg'),
    courses: [
      {
...

  {
    ...
    facultyImage: require('../assets/images/multi_course1.jpg'),
    courses: [
      {
